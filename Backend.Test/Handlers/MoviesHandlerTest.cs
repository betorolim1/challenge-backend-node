...
namespace Backend.Test.Handlers
{
    public class MoviesHandlerTest
    {
        ...
        [Fact]
        public async Task Deve_notificar_caso_titulo_seja_nulo()
        {
        ...
        [Fact]
        public async Task Deve_notificar_caso_plot_seja_invalido()
        {
            var command = new GetMoviesByTitleCommand
            {
                Plot = 99,
        ...
        [Fact]
        public async Task Deve_retornar_corretamente_quando_nao_tiver_dados()
        {
            var command = new GetMoviesByTitleCommand
            {
                Plot = 1,
            ...
            serviceMock.Setup(x => x.RequestMoviesAsync("TitleTest", 2020, 1));
        ...
        [Fact]
        public async Task Deve_retornar_corretamente_todos_os_dados()
        {
            var command = new GetMoviesByTitleCommand
            {
                Plot = 1,
            ...
            serviceMock.Setup(x => x.RequestMoviesAsync("TitleTest", 2020, 1)).ReturnsAsync(response);
